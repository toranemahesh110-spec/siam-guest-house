const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-c9umuAGr.js","assets/ImageCard-5kfw9ro7.js","assets/LuxuryButton-CdSfFH9J.js","assets/ScrollFadeIn-Dm2n9dmv.js","assets/SectionHeading-BuwlcLEj.js","assets/About-BsE5jz1M.js","assets/Rooms-BQ80IBzN.js","assets/Gallery-BK0PFqhK.js","assets/Contact-Cu6bd_Np.js","assets/Booking-B38MAwGg.js"])))=>i.map(i=>d[i]);
...
const rooms = [
  {
    ...
    type: "Deluxe",
    price: 4800,
    description: "Wake up to panoramic views of the Gulf of Thailand in our Deluxe Ocean Room. Featuring a king-size bed with premium Thai silk linens, a private balcony, and an ensuite marble bathroom with a deep soaking tub. Every detail has been curated for the discerning traveler.",
  ...
  },
  {
    ...
    type: "Suite",
    price: 9500,
    description: "The pinnacle of Thai luxury. Our Royal Suite spans an entire floor with sweeping 180-degree ocean vistas, a separate living room, a private dining area, and a butler on call 24 hours. An unrivalled sanctuary above the azure waters of Pattaya.",
  ...
  },
  {
    ...
    type: "Villa",
    price: 7200,
    description: "Secluded in lush tropical gardens, the Garden Terrace Villa offers a private plunge pool, an outdoor sala for open-air dining, and authentic Thai decor celebrating the artisans of the region. A retreat within a retreat.",
  ...
  },
  {
    ...
    type: "Classic",
    price: 2900,
    description: "An elegant introduction to Siam Guest House. The Classic Comfort Room combines warm teak wood accents, a queen-size bed dressed in 400-thread-count linens, and a serene garden-view balcony — all at an accessible entry point for luxury.",
...
const amenities = [
  {
    icon: "🏊",
    title: "Infinity Pool",
    description: "A horizon-edge pool merging seamlessly with the Gulf of Thailand."
  },
  {
    icon: "🌿",
    title: "Thai Spa",
    description: "Indulge in ancient healing rituals performed by master therapists."
  },
  {
    icon: "🍜",
    title: "Fine Dining",
    description: "Curated Thai and international menus crafted by award-winning chefs."
  },
  {
    icon: "🏋️",
    title: "Fitness Suite",
    description: "State-of-the-art gym with private training and sea-view cardio."
  },
  {
    icon: "🛥️",
    title: "Water Sports",
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 pt-16 pb-10 grid grid-cols-1 md:grid-cols-3 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-normal text-white", children: "Siam Guest House" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "font-body text-[10px] tracking-[0.28em] uppercase mt-1",
                  style: { color: "#D4AF37" },
                  children: "Pattaya, Thailand"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "accent-line", style: { background: "#D4AF37" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body font-light text-sm text-white/60 leading-relaxed max-w-xs", children: "A sanctuary of Thai hospitality on the shores of the Gulf of Thailand. Where tradition meets contemporary luxury." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-xs tracking-[0.2em] uppercase text-white/40", children: "Explore" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-xs tracking-[0.2em] uppercase text-white/40", children: "Contact" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("address", { className: "not-italic flex flex-col gap-3 text-sm font-light text-white/70", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  className: "hover:text-white transition-smooth",
                  children: "reservations@siamguesthouse.com"
                }
              )
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs font-light text-white/35", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "© ",
            year,
            " Siam Guest House Pattaya. All rights reserved."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
...
function Navbar() {
  ...
  const prevPath = reactExports.useRef(pathname);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        className: `fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${scrolled ? "glass-nav shadow-subtle py-3" : "py-5 bg-transparent"}`,
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 flex items-center justify-between", children: [
            ...
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `font-display text-xl font-normal tracking-wide transition-smooth ${scrolled ? "text-foreground" : "text-white text-hero-shadow"}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `font-body text-[9px] tracking-[0.28em] uppercase transition-smooth ${scrolled ? "text-gold" : "text-white/70"}`,
                    style: { color: scrolled ? "#D4AF37" : void 0 },
                    children: "Pattaya"
                  }
                )
              ]
            ...
            "nav",
            {
              ...
              children: [
                navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    to: link.to,
                    className: `font-body text-xs tracking-[0.18em] uppercase transition-smooth relative after:absolute after:-bottom-1 after:left-0 after:h-px after:bg-gold after:transition-all after:duration-300 ${currentPath === link.to ? "after:w-full text-gold" : "after:w-0 hover:after:w-full"} ${scrolled ? currentPath === link.to ? "text-gold" : "text-foreground hover:text-foreground" : currentPath === link.to ? "text-gold" : "text-white/85 hover:text-white"}`,
                    style: currentPath === link.to ? { color: "#D4AF37" } : void 0,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              className: `md:hidden p-2 transition-smooth ${scrolled ? "text-foreground" : "text-white"}`,
      ...
      "div",
      {
        ...
        children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              to: link.to,
              className: `font-display text-2xl font-normal transition-smooth ${currentPath === link.to ? "text-gold" : "text-white hover:text-gold"}`,
              style: currentPath === link.to ? { color: "#D4AF37" } : void 0,
...
const HomePage = reactExports.lazy(
  () => __vitePreload(() => import("./Home-c9umuAGr.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0).then((m) => ({ default: m.HomePage }))
);
const AboutPage = reactExports.lazy(
  () => __vitePreload(() => import("./About-BsE5jz1M.js"), true ? __vite__mapDeps([5,2,3,4]) : void 0).then((m) => ({ default: m.AboutPage }))
);
const RoomsPage = reactExports.lazy(
  () => __vitePreload(() => import("./Rooms-BQ80IBzN.js"), true ? __vite__mapDeps([6,2,3]) : void 0).then((m) => ({ default: m.RoomsPage }))
);
const GalleryPage = reactExports.lazy(
  () => __vitePreload(() => import("./Gallery-BK0PFqhK.js"), true ? __vite__mapDeps([7,1,3]) : void 0).then((m) => ({ default: m.GalleryPage }))
);
const ContactPage = reactExports.lazy(
  () => __vitePreload(() => import("./Contact-Cu6bd_Np.js"), true ? __vite__mapDeps([8,3,4]) : void 0).then((m) => ({ default: m.ContactPage }))
);
const BookingPage = reactExports.lazy(
  () => __vitePreload(() => import("./Booking-B38MAwGg.js"), true ? __vite__mapDeps([9,3,4]) : void 0).then((m) => ({ default: m.BookingPage }))
);
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-screen" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) })
});
